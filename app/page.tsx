    ...
    <main id="main-content" className="flex min-h-screen flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 relative h-[50vh] md:h-screen group overflow-hidden">
        <Image
          ...
          priority
        />
        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 translate-y-full opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 ease-in-out pointer-events-none">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-start px-4 sm:px-6 md:px-16 py-8 sm:py-12 md:py-0 bg-background">
        <div className="mb-6 md:mb-8">
          <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-0 leading-tight pb-3 overflow-visible">
        ...
        <p className="text-sm sm:text-xs md:text-sm text-muted-foreground leading-relaxed max-w-xl">
        ...
        <p className="text-sm sm:text-xs md:text-sm text-muted-foreground leading-relaxed max-w-xl mt-4">
